...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-yw4l">
       1.基本上每天实现一道算法<br>
       2.搭建SSM框架<br>
       3.完成注册登录框架的搭建，理解加盐算法，调试sql语句<br>
  ...
  <tr>
   <tr>
    ...
    <td class="tg-yw4l"> 
      1.这周学习了redis的基本命令和用法，了解了Redis中的RDB和AOF两种持久化方式；<br>
      2.总结了spring，springMVC，mybatis三种框架并进行了整合。<br>
      3.与大家讨论完成了数据库和类图的设计；<br>
      4.开始进行业务开发，实现了发帖的功能；<br>
      5.复习了以前学习的一些知识。
    </td>
    <td class="tg-yw4l">
      1.开发并实现所有的业务功能；<br>
...
-    <td class="tg-yw4l">1本周学习了MySQL定时事件,索引的底层结构和左前缀等原则，以及Python的基础语法应用<br>
...
下周计划完成项目大部分的开发并和前端联调，完成几个较难算法问题  如当前状态是否为汉诺塔N阶最优解中间状态的思路整理写成博文</td>  
  ...
  <tr>
    ...
    <td class="tg-yw4l">
      1，SSM框架的运行原理<br>
      2，搭建SSM框架（基于项目的SSM框架的搭建）<br>
      模块功能已经基本可以实现。<br>
      3，mybatis  的学习<br>
      4，远程服务器的搭建，安装数据库，jdk  ，tomcat  。<br>
      5，了解数据库的索引的实现原理，以及作用和缺点。<br>
      6，TCP/IP协议<br>
      7，springMvc的学习
    </td>
    <td class="tg-yw4l">
